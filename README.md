...
VIII.	Final Result Demo
The following image shows a typical demo result for top 10 rated hotel in a district.
![normalization2](https://github.com/ningyixue/AIPI590/blob/main/demo.png)<br />
